    ...
    <Container id="about" style=" max-xl:overflow-x-clip">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="relative z-10">
          ...
          <p className="leading-relaxed text-md  first-letter:font-bold text-balance text-slate-400 max-w-lg mb-6  md:-mt-10">
            {lang
          ...
          <p className="leading-relaxed  first-letter:font-bold text-md text-balance text-slate-400 max-w-lg md:mb-10 mb-5">
            {lang
