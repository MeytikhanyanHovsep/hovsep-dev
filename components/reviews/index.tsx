...
const reviews: Review[] = [
  {
    ...
    proff: ["founder of the company", "Основатель компании"],

    link: "https://kwork.ru/user/michalpalih",
    img: "mikhail.webp",
  },

  {
    ...
    proff: ["PHP Developer", "PHP Разработчик"],
    link: "https://kwork.ru/user/11alister",
    img: "alex.webp",
  },
  {
    name: "Innovatix",
    ...
    proff: ["Company", "Компания"],
    link: "https://kwork.ru/user/innovatixdev",
  ...
  },
  {
    ...
    proff: ["Designer", "Дизайнер"],
    link: "https://kwork.ru/user/onlinerucoy127",
    img: "mher.webp",
  },
  {
    name: "Vladislav",
    ...
    link: "https://kwork.ru/user/ynggways",
    proff: ["FullStack developer", "FullStack разработчик"],
    img: "vladislav.webp",
  },

  {
    ...
    link: "https://kwork.ru/user/aignatov92",
    proff: ["project manager", "менеджер проекта"],
    img: "alexander.webp",
  },

  {
    ...
    link: "https://kwork.ru/user/sivell",
    proff: ["project manager", "менеджер проекта"],
  ...
  },
  {
    ...
    link: "https://kwork.ru/user/andreybolonin1989",
    proff: ["PHP Developer", "PHP Разработчик"],
  ...
  return (
    <>
      <Container id="reviews">
        ...
        >
          {lang ? "Trusted by partners" : "Доверие партнеров"}
        </Title>
      </Container>
